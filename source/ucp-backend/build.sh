...
echo "**********************************************"
echo "* ucp-backend deployement for env '$env' "
echo "***********************************************"
if [ -z "$env" ] || [ -z "$bucket" ]
then
...
zip main.zip bootstrap ../tah-common/tah-common-glue-schemas/*
mkdir -p ../../deployment/global-s3-assets/json_schemas
mkdir -p ../../deployment/regional-s3-assets
cp main.zip  ../../deployment/regional-s3-assets/ucpBackEnd.zip
cp -r ../tah-common/tah-common-json-schemas/* ../../deployment/global-s3-assets/json_schemas/.
cp -r ./e2e/ucp.postman_collection.json ../../deployment/global-s3-assets/ucp.postman_collection.json
fi
