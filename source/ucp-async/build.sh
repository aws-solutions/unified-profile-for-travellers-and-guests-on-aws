...
echo "**********************************************"
echo "* ucp-async deployment for env '$env' "
echo "***********************************************"
...
cp -r ../tah-common/tah-common-glue-schemas/ ./tah-common-glue-schemas/
zip main.zip bootstrap tah-common-glue-schemas/*
mkdir -p ../../deployment/regional-s3-assets
cp main.zip  ../../deployment/regional-s3-assets/$FUNCTION_NAME.zip
rm -r main.zip bootstrap tah-common-glue-schemas/