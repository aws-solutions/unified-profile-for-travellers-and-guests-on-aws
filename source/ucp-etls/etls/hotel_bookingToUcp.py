...
from tah_lib.hotel_bookingTransform import build_object_record
...
explode_and_write(glueContext, accpRecordsDF, "hotel_booking_recs", "hotel_booking",
...
explode_and_write(glueContext, accpRecordsDF, "common_phone_recs", "phone_history",
                args, dynamodb_client, count)
explode_and_write(glueContext, accpRecordsDF, "guest_loyalty_recs", "hotel_loyalty",
                args, dynamodb_client, count)
