...
from tah_lib.pax_profileTransform import build_object_record
...
explode_and_write(glueContext, accpRecordsDF, "air_profile_recs", "pax_profile",
...
explode_and_write(glueContext, accpRecordsDF, "air_loyalty_recs", "air_loyalty",
                args, dynamodb_client, count)
explode_and_write(glueContext, accpRecordsDF, "air_loyalty_tx_recs", "loyalty_transaction",
                args, dynamodb_client, count)
