...
export type ApiDataState<EntityType> = EntityState<EntityType> & StatusAndError;
...
type ValidateRulesFunc = (rules: any) => ValidationResult;

// Define the generic type for the trigger function
type SaveTriggerFunc<T> = (request: T) => Promise<void>;
