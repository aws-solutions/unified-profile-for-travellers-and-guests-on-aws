...
func TestUniqueID(t *testing.T) {
	...
	for i := 0; i < 10000; i++ {
		...
		if _, ok := exists[uid]; ok {
			t.Errorf("[UniqueID] error generating unique UID: ID %v already exists", uid)
			break
		}
		exists[uid] = true
	}
...
func TestUniqueUUID(t *testing.T) {
	...
	for i := 0; i < 10000; i++ {
		uuid := UUID()
		log.Printf("uid: %v", uuid)
		if _, ok := exists[uuid]; ok {
			t.Errorf("[UUID] error generating unique UID: ID %v already exists", uuid)
			break
		}
		exists[uuid] = true
	}
...
func TestLogObfuscation(t *testing.T) {
	...
	expected = `[tx-2733684515] [ind_connector] [Run] Request from API Gateway: {Resource:/{connector}/{usecase} Path://api/hapi/processBookingFeed HTTPMethod:POST Headers:map[Content-Length:6249 Content-Type:application/json Host:example.com Postman-Token:60660ba3-e76f-47c3-a7c5-3a662081b075 User-Agent:PostmanRuntime/7.29.2 X-Amzn-Trace-Id:Root=1-63691ad1-4cc12c1f22360d7d72754005 X-Forwarded-For:24.62.100.140 X-Forwarded-Port:443 X-Forwarded-Proto:https accept:*/* accept-encoding:gzip, deflate, br authorization:Bearer eyJraWQiOiJGUXFHMXRRQ2czWFUyYTJYalJCMFhnZkRJbU9ldTFnTnJ3cFpBZ3hhV244PSIsImFsZyI6IlJTMjU2In0..c1_QNasvSRzMpmyoCV4yYxFnJHh9H0z9WlAOLRfqC9GyFvw7zOGcejM77QK5LvrlZQgMyfAlscdFOlGFvhHBfBzQCxli96JDcE8Z67I35kWpSXsejJ3W2pKTi97cOayAPC5Yv591yklhn3cRCFHXcEzgziTZETS60FdCHrw0saGjD7H588Se7079NAudmti2zBOcDmuD5jsuwqmj_l3NUSlfTKidbJu9rzGYy-arOhqJSQkTCG7BSlJavOSjA43Co9taqZ8W9mcUaGuEcBEKSYJPS7E8cEzfQ7yGgaoiHLv1anKe7D006BeUbAiO2Y8jdbmQpQQNPI32HyZMkj2fqQ cache-control:no-cache] MultiValueHeaders:map[Content-Length:[6249] Content-Type:[application/json] Host:[example.com] Postman-Token:[60660ba3-e76f-47c3-a7c5-3a662081b075] User-Agent:[PostmanRuntime/7.29.2] X-Amzn-Trace-Id:[Root=1-63691ad1-4cc12c1f22360d7d72754005] X-Forwarded-For:[24.62.100.140] X-Forwarded-Port:[443] X-Forwarded-Proto:[https] accept:[*/*] accept-encoding:[gzip, deflate, br] authorization:[Bearer eyJraWQiOiJGUXFHMXRRQ2czWFUyYTJYalJCMFhnZkRJbU9ldTFnTnJ3cFpBZ3hhV244PSIsImFsZyI6IlJTMjU2In0..c1_QNasvSRzMpmyoCV4yYxFnJHh9H0z9WlAOLRfqC9GyFvw7zOGcejM77QK5LvrlZQgMyfAlscdFOlGFvhHBfBzQCxli96JDcE8Z67I35kWpSXsejJ3W2pKTi97cOayAPC5Yv591yklhn3cRCFHXcEzgziTZETS60FdCHrw0saGjD7H588Se7079NAudmti2zBOcDmuD5jsuwqmj_l3NUSlfTKidbJu9rzGYy-arOhqJSQkTCG7BSlJavOSjA43Co9taqZ8W9mcUaGuEcBEKSYJPS7E8cEzfQ7yGgaoiHLv1anKe7D006BeUbAiO2Y8jdbmQpQQNPI32HyZMkj2fqQ] cache-control:[no-cache]] QueryStringParameters:map[] MultiValueQueryStringParameters:map[] PathParameters:map[connector:hapi usecase:processBookingFeed] StageVariables:map[] RequestContext:{AccountID:9999999999 ResourceID:POST /{connector}/{usecase} OperationName: Stage:api DomainName:example.com DomainPrefix:wnb5esk1q8 RequestID:bPEgyhxRFiAEMsg= ExtendedRequestID:bPEgyhxRFiAEMsg= Protocol:HTTP/1.1 Identity:{CognitoIdentityPoolID: AccountID: CognitoIdentityID: Caller: APIKey: APIKeyID: AccessKey: SourceIP:24.62.100.140 CognitoAuthenticationType: CognitoAuthenticationProvider: UserArn: UserAgent:PostmanRuntime/7.29.2 User:} ResourcePath:/{connector}/{usecase} Path:/api/hapi/processBookingFeed Authorizer:map[claims:map[auth_time:1667832520 client_id:41cj0ph407im8ldobfidr11dbo exp:1667836120 iat:1667832520 iss:https://example.com jti:92a3e122-56eb-4c4f-a977-d32cfaa1b2fd scope:users/programmatic sub:41cj0ph407im8ldobfidr11dbo token_use:access version:2] scopes:<nil>] HTTPMethod:POST RequestTime:07/Nov/2022:14:48:49 +0000 RequestTimeEpoch:1667832529604 APIID:wnb5esk1q8} Body:******************** IsBase64Encoded:false}`
	if obfuscated != expected {
		t.Errorf("[TestLogObfuscation] log oobfuscation failed: %v\n should be %v", obfuscated, expected)
	}
...
func TestErrorsToError(t *testing.T) {
	err := ErrorsToError([]error{nil, nil, nil})
	if err != nil {
		t.Errorf("[ErrorsToError] shoudl be nil not : %+v", err)
	}
	err = ErrorsToError([]error{})
	if err != nil {
		t.Errorf("[ErrorsToError] shoudl be nil not : %+v", err)
	}
	err = ErrorsToError([]error{errors.New("test error"), nil, nil})
	if err == nil {
		t.Errorf("[ErrorsToError] shoudl not be nil")
	}
}

func TestTruncateString(t *testing.T) {
	testCases := map[string]map[int]string{
	...
	for input, expected := range testCases {
		for len, expString := range expected {
			truncated := TruncateString(input, len)
			if truncated != expString {
				t.Errorf("[TruncateString] Invalid truncated string: %s shoudl be %s", truncated, expString)
			}
		}
	}
}
...
var LOG_LINE_WITH_LINE_BREAK = `[tx-2733684515] [ind_connector] [Run] Request from API Gateway: {Resource:/{connector}/{usecase} Path://api/hapi/processBookingFeed HTTPMethod:POST Headers:map[Content-Length:6249 Content-Type:application/json Host:example.com Postman-Token:60660ba3-e76f-47c3-a7c5-3a662081b075 User-Agent:PostmanRuntime/7.29.2 X-Amzn-Trace-Id:Root=1-63691ad1-4cc12c1f22360d7d72754005 X-Forwarded-For:24.62.100.140 X-Forwarded-Port:443 X-Forwarded-Proto:https accept:*/* accept-encoding:gzip, deflate, br authorization:Bearer eyJraWQiOiJGUXFHMXRRQ2czWFUyYTJYalJCMFhnZkRJbU9ldTFnTnJ3cFpBZ3hhV244PSIsImFsZyI6IlJTMjU2In0..c1_QNasvSRzMpmyoCV4yYxFnJHh9H0z9WlAOLRfqC9GyFvw7zOGcejM77QK5LvrlZQgMyfAlscdFOlGFvhHBfBzQCxli96JDcE8Z67I35kWpSXsejJ3W2pKTi97cOayAPC5Yv591yklhn3cRCFHXcEzgziTZETS60FdCHrw0saGjD7H588Se7079NAudmti2zBOcDmuD5jsuwqmj_l3NUSlfTKidbJu9rzGYy-arOhqJSQkTCG7BSlJavOSjA43Co9taqZ8W9mcUaGuEcBEKSYJPS7E8cEzfQ7yGgaoiHLv1anKe7D006BeUbAiO2Y8jdbmQpQQNPI32HyZMkj2fqQ cache-control:no-cache] MultiValueHeaders:map[Content-Length:[6249] Content-Type:[application/json] Host:[example.com] Postman-Token:[60660ba3-e76f-47c3-a7c5-3a662081b075] User-Agent:[PostmanRuntime/7.29.2] X-Amzn-Trace-Id:[Root=1-63691ad1-4cc12c1f22360d7d72754005] X-Forwarded-For:[24.62.100.140] X-Forwarded-Port:[443] X-Forwarded-Proto:[https] accept:[*/*] accept-encoding:[gzip, deflate, br] authorization:[Bearer eyJraWQiOiJGUXFHMXRRQ2czWFUyYTJYalJCMFhnZkRJbU9ldTFnTnJ3cFpBZ3hhV244PSIsImFsZyI6IlJTMjU2In0..c1_QNasvSRzMpmyoCV4yYxFnJHh9H0z9WlAOLRfqC9GyFvw7zOGcejM77QK5LvrlZQgMyfAlscdFOlGFvhHBfBzQCxli96JDcE8Z67I35kWpSXsejJ3W2pKTi97cOayAPC5Yv591yklhn3cRCFHXcEzgziTZETS60FdCHrw0saGjD7H588Se7079NAudmti2zBOcDmuD5jsuwqmj_l3NUSlfTKidbJu9rzGYy-arOhqJSQkTCG7BSlJavOSjA43Co9taqZ8W9mcUaGuEcBEKSYJPS7E8cEzfQ7yGgaoiHLv1anKe7D006BeUbAiO2Y8jdbmQpQQNPI32HyZMkj2fqQ] cache-control:[no-cache]] QueryStringParameters:map[] MultiValueQueryStringParameters:map[] PathParameters:map[connector:hapi usecase:processBookingFeed] StageVariables:map[] RequestContext:{AccountID:9999999999 ResourceID:POST /{connector}/{usecase} OperationName: Stage:api DomainName:example.com DomainPrefix:wnb5esk1q8 RequestID:bPEgyhxRFiAEMsg= ExtendedRequestID:bPEgyhxRFiAEMsg= Protocol:HTTP/1.1 Identity:{CognitoIdentityPoolID: AccountID: CognitoIdentityID: Caller: APIKey: APIKeyID: AccessKey: SourceIP:24.62.100.140 CognitoAuthenticationType: CognitoAuthenticationProvider: UserArn: UserAgent:PostmanRuntime/7.29.2 User:} ResourcePath:/{connector}/{usecase} Path:/api/hapi/processBookingFeed Authorizer:map[claims:map[auth_time:1667832520 client_id:41cj0ph407im8ldobfidr11dbo exp:1667836120 iat:1667832520 iss:https://example.com jti:92a3e122-56eb-4c4f-a977-d32cfaa1b2fd scope:users/programmatic sub:41cj0ph407im8ldobfidr11dbo token_use:access version:2] scopes:<nil>] HTTPMethod:POST RequestTime:07/Nov/2022:14:48:49 +0000 RequestTimeEpoch:1667832529604 APIID:wnb5esk1q8} Body:        {
"data": {
"propertyDetails": {
"code": "HHOTEL",
"chainCode": "HAPI"
...
func TestTransaction_IsLevelEnabled(t *testing.T) {
	tests := []struct {
		name      string
		logLevel  LogLevel
		testLevel LogLevel
		...
		{
			name:      "Debug level enables info logs",
			logLevel:  LogLevelDebug,
			testLevel: LogLevelInfo,
			want:      true,
		},
		{
			name:      "Debug level enables warn logs",
			logLevel:  LogLevelDebug,
			testLevel: LogLevelWarn,
			want:      true,
		},
		{
			name:      "Debug level enables error logs",
			logLevel:  LogLevelDebug,
		...
		{
			name:      "Info level enables info logs",
			logLevel:  LogLevelInfo,
			testLevel: LogLevelInfo,
			want:      true,
		},
		{
			name:      "Info level enables warn logs",
			logLevel:  LogLevelInfo,
			testLevel: LogLevelWarn,
			want:      true,
		},
		{
			name:      "Info level enables error logs",
			logLevel:  LogLevelInfo,
			testLevel: LogLevelError,
			want:      true,
		},
		...
		// Warn level tests
		{
			name:      "Warn level disables debug logs",
		...
		{
			name:      "Warn level enables error logs",
			logLevel:  LogLevelWarn,
			testLevel: LogLevelError,
			want:      true,
		},
		...
		// Error level tests
		{
			name:      "Error level disables debug logs",
			logLevel:  LogLevelError,
			testLevel: LogLevelDebug,
			want:      false,
		},
		{
			name:      "Error level disables info logs",
			logLevel:  LogLevelError,
			testLevel: LogLevelInfo,
			want:      false,
		},
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			tx := NewTransaction("", "", tt.logLevel)
			got := tx.isLevelEnabled(tt.testLevel)
			if got != tt.want {
