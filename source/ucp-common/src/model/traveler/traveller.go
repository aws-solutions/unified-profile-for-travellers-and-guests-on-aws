...
type Traveller struct {
	...
	// Object Type Records counts (to be used for pagination (and other))

	NAirBookingRecords                 int64 `json:"nAirBookingRecords"`
	NAirLoyaltyRecords                 int64 `json:"nAirLoyaltyRecords"`
	NLoyaltyTxRecords                  int64 `json:"nLotaltyTxRecords"`
	NClickstreamRecords                int64 `json:"nClickstreamRecords"`
	NEmailHistoryRecords               int64 `json:"nEmailHistoryRecords"`
	NHotelBookingRecords               int64 `json:"nHotelBookingRecords"`
	NHotelLoyaltyRecords               int64 `json:"nHotelLoyaltyRecords"`
	NHotelStayRecords                  int64 `json:"nHotelStayRecords"`
	NPhoneHistoryRecords               int64 `json:"nPhoneHistoryRecords"`
	NCustomerServiceInteractionRecords int64 `json:"nCustomerServiceInteractionRecords"`
	NAncillaryServiceRecords           int64 `json:"nAncillaryServiceRecords"`
	NAlternateProfileIdRecords         int64 `json:"nAlternateProfileIdRecords"`
	// Object Type Records
	...
	AlternateProfileIDs               []AlternateProfileID         `json:"alternateProfileIds"`
...
type AirBooking struct {
	...
	OverallConfidenceScore float64   `json:"overallConfidenceScore"`
	TravellerID            string    `json:"travellerId"`
...
type AirLoyalty struct {
	...
	DateTimeFormatPref     string    `json:"dateTimeFormatPreference"`
	...
	NextBillAmount         float64   `json:"nextBillAmount"`
	...
	ClearNextBillAmount    float64   `json:"clearNextBillAmount"`
...
type CustomerServiceInteraction struct {
	...
	CampaignJobID          string    `json:"campaignJobId"`
	CampaignStrategy       string    `json:"campaignStrategy"`
	CampaignProgram        string    `json:"campaignProgram"`
	CampaignProduct        string    `json:"campaignProduct"`
	CampaignName           string    `json:"campaignName"`
	Category               string    `json:"category"`
	Subject                string    `json:"subject"`
	LoyaltyProgramName     string    `json:"loyaltyProgramName"`
	IsVoiceOtp             bool      `json:"isVoiceOtp"`
}
...
type Interaction struct {
	Type        string    `json:"interactionType"`
	Date        time.Time `json:"interactionDate"`
	Description string    `json:"interactionDescription"`
}

type AlternateProfileID struct {
	Name         string    `json:"name"`                  //	Name of the AltProfileID, e.g. "airline"
	Value        string    `json:"value"`                 //	Value of the ID
	Description  string    `json:"description,omitempty"` //	Optional more descriptive name
	AccpObjectID string    `json:"accpObjectID"`          //	Underscore-concatenated ID -> name_value
	TravellerID  string    `json:"travellerId"`
	LastUpdated  time.Time `json:"lastUpdated"`
}

// LastUpdatedTime implements AccpObject.
func (altProfId AlternateProfileID) LastUpdatedTime() time.Time {
	return altProfId.LastUpdated
}

// ID implements AccpObject.
func (altProfId AlternateProfileID) ID() string {
	return altProfId.AccpObjectID
}
