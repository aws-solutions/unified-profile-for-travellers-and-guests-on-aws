...
echo "**********************************************"
echo "* ucp-industry-connector-transfer deployement for env '$env' "
echo "***********************************************"
...
go build -mod=vendor -o bootstrap src/main.go
rc=$?
if [ $rc -ne 0 ]; then
...
cp main.zip  ../../deployment/regional-s3-assets/ucpIndustryConnector.zip
