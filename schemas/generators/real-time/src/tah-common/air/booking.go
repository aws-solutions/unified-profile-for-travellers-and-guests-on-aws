...
type BookingPrice struct {
	PriceItems []PricePerPassengerPerSegments `json:"priceItems"`
...
type PricePerPassengerPerSegments struct {
	...
	PassengerIndex int    `json:"passengerIndex"` //refers to the index ofthe passenger in the passenger list
...
type AncillaryServicePrice struct {
	...
	AmountBeforeTaxes core.Float `json:"amount"`
