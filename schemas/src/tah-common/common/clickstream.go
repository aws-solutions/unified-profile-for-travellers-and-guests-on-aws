...
var EVENT_ATTRIBUTE_SELECTED_SEATS = "selected_seats"              //selected seats (ex: [Choose seat|37E,13B|Choose seat])
...
type ClickEvent struct {
	...
	Application         EventApplication     `json:"application,omitempty"`
	Client              EventClient          `json:"client,omitempty"`
	Device              EventDevice          `json:"device,omitempty"`
...
func (clickEvent ClickEvent) MarshalJSON() ([]byte, error) {
	...
	return json.Marshal(&struct {
		...
		Alias:            (Alias)(clickEvent),
		EventTimestamp:   clickEvent.EventTimestamp.Format(core.INGEST_TIMESTAMP_FORMAT),
		ArrivalTimestamp: clickEvent.ArrivalTimestamp.Format(core.INGEST_TIMESTAMP_FORMAT),
	})
}
...
type EventAttribute struct {
	...
	NumValue     core.Float   `json:"numValue,omitempty"`
	NumValues    []core.Float `json:"numValues,omitempty"`
}
...
type EventDevice struct {
	...
	IpAddress string `json:"ipAddress,omitempty"` // "The ID Address if the device
}
