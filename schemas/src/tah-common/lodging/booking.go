...
type Booking struct {
	...
	PaymentInformation  common.PaymentInformation `json:"paymentInformation,omitempty"`
	ContextId           string                    `json:"contextId,omitempty"`
	GroupId             string                    `json:"groupId,omitempty"`
	Status              string                    `json:"status"`
	Currency            common.Currency           `json:"currency"`
	CancelReason        common.CancellationReason `json:"cancelReason,omitempty"`
	Segments            []BookingSegment          `json:"segments"`
	Comments            []common.Comment          `json:"comments,omitempty"`
...
type BookingSegment struct {
	...
	Holder             GuestProfile              `json:"holder"`
	AdditionalGuests   []GuestProfile            `json:"additionalGuests,omitempty"`
	PaymentInformation common.PaymentInformation `json:"paymentInformation,omitempty"`
	GroupId            string                    `json:"groupId,omitempty"`
	Status             string                    `json:"status"`
...
type BookingPrice struct {
	PricePerNight                   []AmountPerNightItem        `json:"pricePerNight,omitempty"`
	TaxePerNight                    []AmountPerNightItem        `json:"taxePerNight,omitempty"`
	PricePerStay                    []AmountPerProductItem      `json:"pricePerStay,omitempty"`
	TaxPerStay                      []AmountPerProductItem      `json:"taxPerStay,omitempty"`
	BusinessRules                   []BusinessRule              `json:"businessRules,omitempty"`
	TotalPricePerNightBeforeTaxes   []TotalAmountPerNightItem   `json:"totalPricePerNightBeforeTaxes,omitempty"`
	TotalPricePerNightAfterTaxes    []TotalAmountPerNightItem   `json:"totalPricePerNightAfterTaxes,omitempty"`
	TotalPricePerProductBeforeTaxes []TotalAmountPerProductItem `json:"totalPricePerProductBeforeTaxes,omitempty"`
	TotalPricePerProductAfterTaxes  []TotalAmountPerProductItem `json:"totalPricePerProductAfterTaxes,omitempty"`
	TotalBeforeTax                  core.Float                  `json:"totalBeforeTax,omitempty" jsonschema:"anyof_required=totalBeforeTax"`
	TotalAfterTax                   core.Float                  `json:"totalAfterTax,omitempty" jsonschema:"anyof_required=totalAfterTax"`
}
